        ...
        <Container>
            ...
            {status === 'succeeded' && (
                ...
                >
                    ...
                    <TextField fullWidth label="Age" value={user.age || ""} inputProps={{ readOnly: true }} />
                    <TextField fullWidth label="Email" value={user.email || ""} inputProps={{ readOnly: true }} />
                    <TextField fullWidth label="Gender" value={getGenderName(user.gender) || ""} inputProps={{ readOnly: true }} />
                </Box>
            )}
        </Container>
    );
